local Translations = {
    error = {
        ...
        no_stand_found = 'Seu carrinho de cachorro-quente não foi encontrado em nenhum lugar. Você não receberá seu depósito de volta!',
        no_more = 'Você não tem mais %{value} disso à frente do conselho',
    ...
    success = {
        ...
        made_hotdog = 'Você fez um Cachorro-Quente %{value}',
        made_luck_hotdog = 'Você fez %{value} x Cachorros-Quentes %{value2}',
    },
    info = {
        ...
        selling_prep = '[~g~E~s~] Preparar Cachorro-Quente [Venda: ~g~Ativa~w~]',
        not_selling = '[~g~E~s~] Preparar Cachorro-Quente [Venda: ~r~Desativada~w~]',
